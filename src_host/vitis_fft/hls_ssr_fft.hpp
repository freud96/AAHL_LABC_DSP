...
#include "hls_ssr_fft_fork_merge_utils.hpp"
#include "hls_ssr_fft_pragma_controls.hpp"
#include "hls_ssr_fft_enums.hpp"
#include "hls_ssr_fft_data_reorder.hpp"
#include "hls_ssr_fft_traits.hpp"
#include "hls_ssr_fft_twiddle_table.hpp"
#include "hls_ssr_fft_complex_exp_table.hpp"
#include "hls_ssr_fft_complex_exp_table_last_stage.hpp"
#include "hls_ssr_fft_streaming_transposer.hpp"
#include "hls_ssr_fft_streaming_data_commutor.hpp"
#include "hls_ssr_fft_adder_tree.hpp"
#include "hls_ssr_fft_input_traits.hpp"
#include "hls_ssr_fft_parallel_fft_kernel.hpp"
#include "hls_ssr_fft_multiplication_traits.hpp"
...
/**
 * @brief top of stream-based SSR FFT (fixed data type)
 *
 * @tparam ssr_fft_param_struct SSR FFT parameter structure that can be redefined by users. The default parameters can
 * be described as:\n
 *
 ...
 * };\n
 * @tparam T_in type of input data
 *
 * @param fftInStrm input SSR FFT points, partitioned with ssr_fft_param_struct::R
 * @param fftOutStrm output SSR FFT results, partitioned with ssr_fft_param_struct::R
 */
template <typename ssr_fft_param_struct, typename T_in>
 ...
 *     static const butterfly_rnd_mode_enum butterfly_rnd_mode = TRN;\n
 * };\n
 * @tparam t_instanceID SSR FFT INSTANCE ID
 * @tparam T_in type of input data
 *
 * @param fftInStrm input SSR FFT points, partitioned with ssr_fft_param_struct::R
 * @param fftOutStrm output SSR FFT results, partitioned with ssr_fft_param_struct::R
